...
public class AccountPageModel {
    ...
    public AccountPageModel(String id, String nCreated_at, String nUpdated_at, String nAlamat, String nLokasi, String nEmail, String nLevel, String nNama, String nNoTlp, String nToken_id, String nGender, String nImageUrl) {
        this.id = id;
